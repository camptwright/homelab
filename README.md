...
| `apps` | dashboard, Miniflux, Uptime Kuma, Linkding, Marketdesk, Beszel hub/agent, Wellthread web/auth/REST/gateway | Live except the reviewed Wellthread web promotion has not yet been applied to CT110 |
...
Wellthread web—are public on GHCR. Compose pins their source-commit tags and
every other production-capable image to immutable registry digests. The
Wellthread web configuration is reviewed but has not yet been applied to CT110.
